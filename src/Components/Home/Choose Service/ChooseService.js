        ...
        <section className="chooseSerivce d-flex justify-content-center align-items-center">
            ...
            <p data-aos="zoom-in-up" className="chooseService-title-before">Our Services</p>
                ...
                <div className="chooseService-body d-flex justify-content-center">
                    ...
                    <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="4500" className="card">
                        <img src={service2} className="card-img-top" alt="Tamam Same Day Delivery Service" />
                        <div className="card-body text-center">
                            <h5 className="card-title">Same day</h5>
                    ...
                    <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="4500" className="card">
                        <img src={service1} className="card-img-top" alt="Tamam Next Day Delivery Service" />
                        <div className="card-body text-center">
                            <h5 className="card-title">Next day</h5>
                    ...
                    <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="4500" className="card">
                        <img src={service3} className="card-img-top" alt="Tamam On Demand Delivery Service" />
                        <div className="card-body text-center">
                            <h5 className="card-title">Urgent Deliveries</h5>
                    ...
                    <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="4500" className="card">
                        <img src={service4} className="card-img-top" alt="Tamam Next Day Delivery Service" />
                        <div className="card-body text-center">
                            <h5 className="card-title">Cash Payment Only</h5>
                    ...
                    <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="4500" className="card">
                        <img src={service5} className="card-img-top" alt="Tamam Same Day Delivery Service" />
                        <div className="card-body text-center">
                    ...
                    <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="4500" className="card">
                        <img src={service6} className="card-img-top" alt="Tamam On Demand Delivery Service" />
                        <div className="card-body text-center">
